const games=[
{image:"images/elden-ring.svg",name:"Elden Ring",genre:"RPG",rating:"4.8",price:"Rp 599.000",old:"Rp 749.000",icon:"✦",color:"#5b3c18",sale:"-20%",desc:"Petualangan fantasi epik dengan dunia luas, pertarungan intens, dan eksplorasi tanpa batas."},
{image:"images/red-dead.svg",name:"Red Dead Redemption 2",genre:"ACTION",rating:"4.7",price:"Rp 499.000",old:"",icon:"♞",color:"#7a2d18",sale:"",desc:"Jelajahi dunia koboi yang luas dengan cerita sinematik dan karakter yang memorable."},
{image:"images/forza.svg",name:"Forza Horizon 5",genre:"RACING",rating:"4.6",price:"Rp 449.000",old:"Rp 549.000",icon:"♢",color:"#205b72",sale:"-18%",desc:"Balapan open-world dengan mobil impian dan pemandangan spektakuler."},
{image:"images/resident.svg",name:"Resident Evil 4",genre:"ACTION",rating:"4.9",price:"Rp 399.000",old:"",icon:"☠",color:"#3b4651",sale:"",desc:"Survival horror penuh ketegangan dengan aksi cepat dan atmosfer gelap."},
{image:"images/god-war.svg",name:"God of War Ragnarök",genre:"ADVENTURE",rating:"4.9",price:"Rp 599.000",old:"Rp 749.000",icon:"⚔",color:"#315b72",sale:"-20%",desc:"Ikuti perjalanan Kratos dan Atreus menghadapi takdir di dunia Norse."},
{image:"images/horizon.svg",name:"Horizon Forbidden West",genre:"ADVENTURE",rating:"4.7",price:"Rp 299.000",old:"",icon:"◈",color:"#7b5a35",sale:"",desc:"Eksplorasi dunia futuristik yang indah dan hadapi mesin-mesin raksasa."},
{image:"images/sekiro.svg",name:"Sekiro: Shadows Die Twice",genre:"ACTION",rating:"4.8",price:"Rp 499.000",old:"",icon:"忍",color:"#50332c",sale:"",desc:"Pertarungan samurai presisi tinggi dalam perjalanan penuh tantangan."},
{image:"images/turbo-kart.svg",name:"Turbo Kart",genre:"RACING",rating:"4.5",price:"Rp 129.000",old:"",icon:"🏎",color:"#673b72",sale:"",desc:"Balapan arcade seru dengan trek unik dan power-up."}
];
...
function openGame(i){
 current=games[i];
 document.getElementById("modalArt").innerHTML=`<img src="${current.image}" alt="${current.name} cover">`;
